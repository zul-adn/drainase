...
function MapsPage({ isLanding, searchData, searchMode, datas, filter, openModal, getAllDatas, getSumDatas, toShow, sumDatas, legend }) {
    ...
    return (
        <div>
            ...
            <MapContainer
                ...
                style={
                    isLanding ?
                        { height: "80vh", borderRadius: 15, zIndex: 1 }
                        :
